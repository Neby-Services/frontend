...
export default function ConfigurationPage() {
	...
	return (
		<main className={`${styles.background} min-h-screen`}>
			<Header />
			<section className="w-full min-[1800px]:mx-auto min-h-screen box-content">
				<div className="py-20 px-4 md:px-16 gap-6 flex flex-col items-center">
					<div className="w-full max-w-2xl bg-white shadow-xl rounded-xl p-8">
						{userData && (
							<div className="flex flex-col md:flex-row items-center justify-center py-3 mb-5 w-full">
